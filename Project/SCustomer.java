...
public class SCustomer extends JFrame {
	...
	public SCustomer() {
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\Project\\StorageCustomerList.txt");
				if(!file.exists()) {
					file.createNewFile();
					}
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\ProjectStorageRentalImage\\shopping cart.jpg"));
