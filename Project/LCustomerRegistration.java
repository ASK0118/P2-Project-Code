...
public class LCustomerRegistration extends JFrame {
	...
	public LCustomerRegistration() {
		...
		lblSize.setFont(new Font("STXinwei", Font.BOLD, 20));
		lblSize.setBounds(465, 101, 126, 37);
		panel_1.add(lblSize);
				...
				if (selection.equals("Fashion Modern")) {
					...
					if (choose.equals("NIKE, ZARRA")){
						  ...
						  if (day <= 7) {
							...
							if (choose.equals("GUCCI, BALENCIAGA")){
								  ...
								  if (day <=7) {
									...
									if (choose.equals("MONCLER, FENDI")){
											  ...
											  if (day<=7) {
												...
												if (choose.equals("Gho, Mezcal")){
													  ...
													  if (day<=7) {
														...
														if (choose.equals("Burundi, Yenimdoll")){
														  ...
														  if (day<=7) {
															...
															if (choose.equals("Vintage, Bell")){
																  ...
																  if (day<=7) {
																	...
																	if (choose.equals("De Polaris, Zalora")){
		...
		btnTotalAmountrm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    for (int i = 0 ; i < model.getRowCount() ; i++) {
			        ...
			        String s = String.valueOf(model.getValueAt(i, 10)); 
		...
		lblNewLabel.setBounds(49, 0, 585, 74);
		...
		textFieldSize.setBounds(648, 112, 189, 26);
		panel_1.add(textFieldSize);
		textFieldSize.setColumns(10);
		
		JLabel lblDay = new JLabel("Day");
		lblDay.setBounds(465, 54, 126, 37);
		panel_1.add(lblDay);
		lblDay.setFont(new Font("STXinwei", Font.BOLD, 20));
		
		textFieldDay = new JTextField();
		textFieldDay.setBounds(648, 62, 189, 37);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(i>=0) {
					...
					textFieldSize.setText(model.getValueAt(i,8).toString());
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Name", "Gender", "Age", "Address", "Phone Number", "Type", "Brand", "Day", "Size", "Price/day(RM)", "Amount(RM)"
			}
		));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    if(i>=0) //if single row is selected than update
			    {
			    	...
			    	model.setValueAt(textFieldSize.getText(), i,8);
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//2.2 Exception Handling
				try {
					File file = new File("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\Project\\LCustomerRegistration.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
