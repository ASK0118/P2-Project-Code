...
public class LAdminInfo extends JFrame {
	...
	public LAdminInfo() {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(i>=0) //if single row is selected than update
			    {
			    	...
			    	model.setValueAt(textFieldSize.getText(),i,2);
		...
		mnAdvertisement.setFont(new Font("SansSerif", Font.BOLD, 15));
		...
		mntmAdvertisement.setFont(new Font("SansSerif", Font.PLAIN, 15));
		...
		btnUpload_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					File file = new File("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\Project\\LAdminInfo.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
