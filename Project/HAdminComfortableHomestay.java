...
public class HAdminComfortableHomestay extends JFrame {
	 ...
	 * Create the frame.
	 */
	public HAdminComfortableHomestay() {
		setTitle("Comfortable Homestay");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 844, 788);
		...
		panel_1.setBounds(43, 379, 688, 310);
		panel.add(panel_1);
		...
		panel_2.setBounds(463, 10, 4, 290);
		panel_1.add(panel_2);
		...
		JLabel lblPrice = new JLabel("Price per day (RM)");
		lblPrice.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblPrice.setBounds(22, 257, 431, 43);
		panel_1.add(lblPrice);
		
		textField_price = new JTextField();
		textField_price.setFont(new Font("Tahoma", Font.BOLD, 20));
		textField_price.setBounds(530, 257, 96, 43);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectedRow() == -1) {
					if (table.getRowCount() == 0) {
						JOptionPane.showMessageDialog(null, "Price confirmed", "Comfortable Homestay",
		...
		btnConfirm.setBounds(549, 699, 141, 42);
		panel.add(btnConfirm);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(738, 250, 0, 1);
		...
		public static void setTable(JTable table) {
			HAdminComfortableHomestay.table = table;
		}
}
