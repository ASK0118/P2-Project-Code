...
public class LEmployee extends JFrame {
	...
	public LEmployee() {
		...
		mntmCloth.setFont(new Font("Segoe UI", Font.PLAIN, 16));
		mnCloth.add(mntmCloth);
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//2.2 Exception Handling
				try {
					File file = new File("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\Project\\LEmployee.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
