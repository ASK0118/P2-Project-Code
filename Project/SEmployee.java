...
public class SEmployee extends JFrame {
	...
	public SEmployee() {
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\Project\\StorageEmployeeList.txt");
				if(!file.exists()) {
					file.createNewFile();
					}
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\USER\\Desktop\\JAVA\\Programming 2 Assignment\\src\\ProjectStorageRentalImage\\human.png"));
